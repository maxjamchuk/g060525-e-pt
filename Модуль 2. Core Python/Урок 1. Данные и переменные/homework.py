...
#     - well_done - сообщение об успехе
#     - student_count - количество студентов
#     - name_user - имя пользователя
#     - average_daily_t - Средняя температура за день
#     - monthly_total_sales - Общий объем продаж за месяц
#     - total_views - Количество просмотров видео
#     - e-mail_user - Электронный адрес пользователя
#     - total_vacant - Количество доступных мест в аудитории
...
#     - total_page - Число страниц в документе
...
#   Вывод:
#   5
mwd = input ("введите число: ")
mwd = int(mwd)
zahl = abs(mwd)
print("модуль числа: ", zahl)
...
s1, s3 = input("введите два слова через пробел: ").split()
print(f"Word 1: {s1} | Word 2: {s3}")
#
...
#   Вывод:
#   8
z1 = int(input("введите целое положительное число: "))
z2 = int(input("еще раз введите целое положительное число: "))
print(pow(z1, z2))
#
...
#   Вывод:
#   19.0
z2, z4 = map(float, input("введите два числа: ").split())
print(z2 + z4)
#
...
#   Вывод:
#   38.0
lange = float(input("введите длину прямоугольника: "))
breite = float(input("введите ширину прямоугольника: "))
print(lange*2 + breite*2)
#
...
#   Вывод:
#   Вы ввели число 7.54
z1 = float(input("введите число: "))
print("Вы ввели число: ", z1)
#
# Задание 12. Напишите программу, которая запрашивает число и выводит его абсолютное (положительное) значение:
#   Введите число:
#   Абсолютное значение:
z1 = int(input("Введите целое число: "))
print("Абсолютное значение: ", abs(z1))
#
...
z1 = int(input("Введите целое число: "))
z1 = float(input("Введите число: "))
print("Результат сложения: ", z1 + z2)
#
...
#   Округленное число:
z1 = float(input("введите дробное число: "))
z2 = int(input("до скольких знаков после запятой нужно округлить: "))
print(round(z1, z2))