...
word_6 = "innovation"
index_6 = str6.lower().find(word_6)
print(f"индекс подстроки:{index_6}")
...
word_8 = "galaxy"
index_8 =str8.lower().find(word_8)
print(f"индекс подстроки:{index_8}")
...
str_11 = "Artificial Intelligence"
print(str_11.upper())
